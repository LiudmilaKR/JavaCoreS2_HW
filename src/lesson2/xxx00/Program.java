...
//            equalsIgnoreCase - игнорирование регистра
    ...
    private static void humanTurn() {
        ...
        do {
            ...
            /**
            while (true) {
                System.out.print("Введите координаты хода X (от 1 до 3): ");
...
//        проверка по диагоналям
    ...
    /**
     * проверка победы по направлению
     * @param x
     * @param y
     * @param win
     * @param dir
     * @return
     */
    static boolean chek1(int x, int y, int win, int dir) {
        return false;
    }
    /**
     * Проверка на ничью
